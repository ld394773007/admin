  ...
  <div class="create-team">
    ...
    <div class="create-team-body">
      ...
      <a href="javascript:"
         ...
         @click="create">开始创建<i class="fas fa-arrow-alt-circle-right common-btn-icon"></i></a>
      <a href="javascript:"
         v-else
         @click="nextStep"
         class="common-btn create-team-btn">下一步<i class="fas fa-arrow-alt-circle-right common-btn-icon"></i></a>
    </div>
  </div>
</template>
